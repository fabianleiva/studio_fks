const Conferences = () => {
  return (
    <main className="pt-[20vh] ">
      ...
      <div className="fixed left-0 px-3 grid grid-cols-[2fr_1fr_2fr] text-[#000000] uppercase w-full bg-[#fafafa] z-50">
      ...
      <div className="pt-[20vh]  ">
        {/* Conferences */}
        <div className="text-left pt-6 col-span-2 mb-40 text-[#adadad] ">
          <div className="flex justify-between mt-1 align-between hover:text-[#000000]">
